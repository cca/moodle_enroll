...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--program', required=False, choices=programs_with_internship, help='Generate enrollments for only a specific program')
    parser.add_argument('-r', '--report', required=False, default='Students_for_Internship_Review.xlsx', help='path to the Workday Excel file')
